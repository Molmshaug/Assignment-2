...
<<<<<<< HEAD:Assignment 2 alle oppgaver.qmd
=======
...
>>>>>>> 16c6a286400936c065341cdfbaf8c173e73936be:Assignment_2_alle_oppgaver.qmd
```{r}
#| include: false
...
#Vi har  ekstrahert DNA fra blodprøver på 4 studenter og har gjennomføty ACTN3 genotyping. En av studentene kom fikk ikke frem DNA i sin prøve. Vi gjennomførte derfor sekvensering av to prøver fra  hver av tre studenter. 
I elektroforese-gelen har vi en "ladder" som er kjente genmarkører. Gjennom FIJI kunne vi hente ut data,  Vi har valgt ut det beste  resultatet fra de tre studentene og  gjort analyser på disse. 
